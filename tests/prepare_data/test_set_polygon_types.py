...
def test_polygon_type_is_updated_correctly_when_mapping_override_exists(session, tables):
    # Polygons use negative IDs but the mapping override table stores them postively
    # so this test needs to use negative IDs in the polygon table otherwise it wont match
