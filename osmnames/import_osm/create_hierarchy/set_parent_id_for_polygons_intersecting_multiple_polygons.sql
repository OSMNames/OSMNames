...
CREATE FUNCTION get_most_intersecting_polygon_id_for_polygon(id_in BIGINT, geometry_in GEOMETRY)
RETURNS BIGINT AS $$
DECLARE
  parent_id BIGINT;
BEGIN
...
UPDATE osm_polygon
  SET parent_id = get_most_intersecting_polygon_id_for_polygon(id, geometry)
