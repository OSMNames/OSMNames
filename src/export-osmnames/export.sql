SELECT r.name,
    ...
    getImportance(r.rank_search, r.wikipedia, r.country) AS importance,
    '' AS street,
    '' AS city,
    '' AS county,
...
UNION SELECT rr.name,
    ...
    getImportance(rr.rank_search, rr.wikipedia, rr.country) AS importance,
        '' AS street,
    '' AS city,
    '' AS county,
...
UNION SELECT rrr.name,
    ...
    getImportance(rrr.rank_search, rrr.wikipedia, rrr.country) AS importance,
    rrr.name AS street,
    '' AS city,
    '' AS county,
    COALESCE(placeName(rrr.state),'') AS state,
